  ...
  useEffect(() => {
    ...
    if (user.role === "OWNER") {
      if (user.ownerType === "PRIVATE") {
        setForm((prev) => ({ ...prev, parkingType: "PRIVATE" }));
      }

      if (user.ownerType === "MUNICIPALITY") {
        setForm((prev) => ({ ...prev, parkingType: "MUNICIPAL" }));
      }
    }
  }, [user]);
          ...
          >
            ...
            >
              ...
              <select
                ...
                disabled={
                  user?.role === "OWNER" // owner не може да сменя
                }
                style={{
                  padding: 12,
                  borderRadius: 10,
                  border: "1px solid #cbd5e1",
                  background: user?.role === "OWNER" ? "#f1f5f9" : "#fff",
